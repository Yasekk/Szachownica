...
def create_board_and_pieces(settings,screen,chess_board,board_pieces):
	...
	for horizontal in range(8):
		for vertical in range(8):
			...
			board_part.rect.left=(settings.width_grid*horizontal+
			settings.chess_field_size*horizontal)+200
			board_part.rect.bottom=(settings.width_grid*
			order_y[vertical]+settings.chess_field_size*
			order_y[vertical])+90
